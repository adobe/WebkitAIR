...
// Since ((0xFFFFFFFFU -(sizeof(ArrayStorage) - sizeof(JSValue))/sizeof(JSValue)) is constant
// and its value decreases for 64bit as sizeof(JSValue) increases for 64bit  thereby decreasing 
// the value of MAX_STORAGE_VECTOR_LENGTH for 64bit which shouldnot be the case. Thus value of
// MAX_STORAGE_VECTOR_LENGTH is multiplied by 2 for 64bit to make them of the same order.

//#define UINT_MAX 0xFFFFFFFFU

#ifdef __x86_64__         
#define MAX_STORAGE_VECTOR_LENGTH static_cast<unsigned>(((UINT_MAX - (sizeof(ArrayStorage) - sizeof(JSValue))) / sizeof(JSValue)) * 2 )
#else
#define MAX_STORAGE_VECTOR_LENGTH static_cast<unsigned>((UINT_MAX - (sizeof(ArrayStorage) - sizeof(JSValue))) / sizeof(JSValue)) 
#endif
