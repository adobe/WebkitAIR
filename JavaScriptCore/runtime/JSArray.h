...
namespace JSC {
    ...
    {
        return v.isCell() && v.asCell()->vptr() == JSGlobalData::jsArrayVPtr;
    }
#else
    inline bool isJSArray(JSGlobalData* globalData, JSValue v)
    {
...
#if PLATFORM(APOLLO)
    inline bool isJSArray(JSGlobalData* /*globalData*/, JSCell* cell) { return cell->vptr() == JSGlobalData::jsArrayVPtr; }
#else
