...
{
    // The code below was modified to work around a Code Optimizer bug in Xcode 4.2 and Xcode 4.6.
    JSObject* volatile theObject = constructArrayWithSizeQuirk(exec, args);
    return theObject;
}
