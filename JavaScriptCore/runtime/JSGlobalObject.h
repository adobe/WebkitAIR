...
namespace JSC {
    ...
    public:
        ...
        virtual EvalLevel currentEvalLevel() const { return EvalAny; }
        virtual bool canConstructFunctions() const { return true; }
        virtual void *platformInterpreterContext() { return 0; }
#endif
