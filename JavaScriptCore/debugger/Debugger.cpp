...
#if PLATFORM(APOLLO) 
void Debugger::sourceParsedFunctions(ExecState*, intptr_t /* sourceId */, ParserArenaData<DeclarationStacks::FunctionStack>* /*funcStack*/)
{
    ASSERT(false);
}
	
void Debugger::returnEvent(const DebuggerCallFrame&, intptr_t /*sourceId*/, int /*lineno*/, bool /*fromReturnCommand*/)
{
    ASSERT(false);
}
	
void Debugger::exception(const DebuggerCallFrame&, intptr_t /*sourceId*/, int /*lineno*/, bool /*isCaughtException*/)
{
    ASSERT(false);
}
#endif
