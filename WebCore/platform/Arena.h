...
#define CLEAR_ARENA(a)  memset((void*)(a), FREE_PATTERN, \
                            (a)->limit - (uword)(a))
*/
static const unsigned char FREE_PATTERN = 0xDA;
inline void CLEAR_UNUSED(Arena* const a)
{
    ASSERT(a);
    ASSERT(a->avail <= a->limit);
    memset((void*)a->avail, FREE_PATTERN, a->limit - a->avail);
}
inline void CLEAR_ARENA( Arena* const a )
{
    memset((void*)a, FREE_PATTERN, a->limit - (uword)a);
}
#else
/*
