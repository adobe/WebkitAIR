...
#if PLATFORM(APOLLO)
    cairo_font_face_set_user_data(fontFace, &bufferKey, face, reinterpret_cast<cairo_destroy_func_t>(FT_Done_Face));
    return new FontCustomPlatformData(fontFace, buffer);
#else
