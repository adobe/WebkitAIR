...
// PANGO_VERSION_CHECK is not defined in older pango-utils.h and so to fix the
// compilation issues, we define it to false here
#ifndef PANGO_VERSION_CHECK
#define PANGO_VERSION_CHECK(major,minor,micro) false 
#endif
