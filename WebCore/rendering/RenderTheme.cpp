...
#if PLATFORM(APOLLO)
#include "apollo/RenderThemeApollo.h"
#endif
...
#if PLATFORM(APOLLO)
    // calling this function removes the need to call setBoxShadow
    (static_cast<RenderThemeApollo*>(this))->disableBoxShadowForControl(part, style);
