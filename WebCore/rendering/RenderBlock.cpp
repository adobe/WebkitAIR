...
void RenderBlock::removeChild(RenderObject* oldChild)
{
    ...
    bool canDeleteAnonymousBlocks = !documentBeingDestroyed() && !isInline() && !oldChild->isInline() && 
                                    ...
                                    (!prev || (prev->isAnonymousBlock() && prev->childrenInline() && !toRenderBlock(prev)->beingDestroyed())) &&
                                    (!next || (next->isAnonymousBlock() && next->childrenInline() && !toRenderBlock(next)->beingDestroyed())) &&
