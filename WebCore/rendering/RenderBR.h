...
public:
    ...
    virtual unsigned width(unsigned /*from*/, unsigned /*len*/, const Font&, int /*xpos*/, HashSet<const SimpleFontData*>*, GlyphOverflow*) const { return 0; }
    virtual unsigned width(unsigned /*from*/, unsigned /*len*/, int /*xpos*/, bool /*firstLine = false*/, HashSet<const SimpleFontData*>* , GlyphOverflow*) const { return 0; }
