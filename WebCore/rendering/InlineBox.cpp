...
{
// apollo - integrate - http://trac.webkit.org/changeset/68186
// LayoutTests crash in AIR because SVG is disabled - editing/selection/extend-byline-withfloat.html
// Some occurences of virtual height logic were intentionally taken out of the SVG
// ifdefs on WebKit trunk, while others were missed. Taking all of the virtual height
// logic out of SVG ifdefs in AIR.
//
// Search for the above changeset to find and modify all the other occurences
#if ENABLE(SVG) || PLATFORM(APOLLO)
    if (hasVirtualHeight())
