...
#if PLATFORM(APOLLO)
        virtual JSC::JSValue getDataValue(const String& type, bool& success) const = 0;
        virtual bool setData(const String& type, JSC::JSValue data) = 0;
        virtual WTF::PassRefPtr<Node> getDataNode(const String& type, bool& success) const = 0;
        virtual bool setData(const String& type, Node* data) = 0;
#endif
...
#if PLATFORM(APOLLO)
        virtual void writePlainText(const String&, Frame*) = 0;
#else
