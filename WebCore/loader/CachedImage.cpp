...
#if PLATFORM(APOLLO)
        // maximumDecodedImageSize is given in pixels. In order to compare with estimatedDecodedImageSize (in bytes)
        // you have to multiply its value by 4. Further integrations will have to keep this in sync with the way
        // estimatedDecodedImageSize is computed.
        size_t maxDecodedImageSize = maximumDecodedImageSize() * 4;
#else
