...
#else
        CachedScript(const String& URL, const String& charset, Type type = Script);
#endif
...
#if PLATFORM(APOLLO)
    class UncachedSWF : public CachedScript {
    public:
        UncachedSWF(const String& URL, const String& charset);
        virtual ~UncachedSWF() {}
    };
#endif
