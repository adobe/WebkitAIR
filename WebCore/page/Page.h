...
// apollo integration
/*
#if PLATFORM(WIN) || ((PLATFORM(WX) ||PLATFORM(APOLLO)) && OS(WIN_OS)) || (PLATFORM(QT) && defined(Q_WS_WIN))
typedef struct HINSTANCE__* HINSTANCE;
#endif
*/
...
//#if PLATFORM(WIN) || (PLATFORM(WX) && OS(WINDOWS)) || (PLATFORM(QT) && defined(Q_WS_WIN)) || PLATFORM(APOLLO_WINDOWS)
...
#if PLATFORM(WIN) || (PLATFORM(WX) && defined(__WXMSW__)) || (PLATFORM(QT) && defined(Q_WS_WIN)) || PLATFORM(APOLLO_WINDOWS)
