...
{
    // assert that the same image is not added to the vector again (See WebKit 34076)
...
{
    // make sure we are removing something we have previously added (See WebKit 34076)
    ASSERT(imgElements.find(e) != notFound);
